  ...
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        ...
        // ✅ TabBar estable y con altura suficiente
        tabBarStyle: {
          height: tabBarHeight,
          paddingTop: 8,
          ...
          // ✅ importante para que no recorte el label en web/mobile
          overflow: "visible",

          ...(Platform.OS === "web" ? { zIndex: 1000 } : null),
        },

        // ✅ label más visible (sin margin negativo)
        tabBarLabelStyle: {
          fontSize: 12,
          fontWeight: "900",
          marginTop: 2, // antes -2 (eso lo cortaba)
          paddingBottom: 0,
        },

        // ✅ ícono un poquito arriba para dejar espacio al label
        tabBarIconStyle: {
          marginTop: 2,
        },
